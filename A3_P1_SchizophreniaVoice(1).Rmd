...
```{r make models}
model_mean = lmer(mean ~Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #nope
model_sd = lmer(sd ~ Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #nope
model_range = lmer(range ~Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) # yes - Dia and Study
model_median = lmer(median ~ Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #nope
model_iqr = lmer(iqr ~ Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #nope
model_absmeandev = lmer(abs_mean_dev ~ Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #nope
model_cofvar = lmer(cof_var ~Diagnosis+Trial+Study+(1+Trial|ID),data,REML=F) #yes Dia
model_RR = lmer(RR ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) #yes Dia
model_DET= lmer(DET ~Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) # yes Dia

model_maxL = lmer(maxL ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) # yes Study
summary(model_maxL)
model_L = lmer(L ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) #nope
model_ENTR = lmer(ENTR ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) #yes Dia and Study
model_LAM = lmer(LAM ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) # yes - Dia and Study
model_TT = lmer(TT ~ Diagnosis+Trial+Study+(1+Trial|ID),na.omit(data),REML=F) # yes Study
```
